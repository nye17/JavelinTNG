...
class FullRankCovariance(Covariance):
    ...
    def continue_cholesky(self, x, x_old, U_old, observed=True, nugget=None, return_eval_also=False):
        ...
        U = zeros((N_new + N_old, N_old + N_new), dtype=float, order='F')
        U[:N_old, :N_old] = U_old
    ...
    def __call__(self, x, y=None, observed=True, regularize=True, return_Uo_Cxo=False):
        ...
        # super(FullRankCovariance, self).__call__(x,y,observed,regularize,return_Uo_Cxo=return_Uo_Cxo, eval_fun=self.eval_fun)
